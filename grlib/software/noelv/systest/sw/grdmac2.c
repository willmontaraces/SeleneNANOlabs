...
int grdmac2_test(int paddr, int en_acc) {

  int test_res = 0;

  report_device(0x010e0000);

  struct grdmac2_register *grdmac2_reg = (struct grdmac2_register *) (paddr & 0xffffffff);
...
// Check if encrypted data is correct
  ...
  memoryrx++;
  if (*memoryrx != 0x775789a5){
    fail(2);
    test_res = 2;
  }
  memoryrx++;
  if (*memoryrx != 0xb7a7f504){
    fail(3);
    test_res = 3;
  }
  memoryrx++;
  if (*memoryrx != 0xbbf3d228){
    fail(4);
    test_res = 4;
  }
  memoryrx++;
...
// Check if encrypted data is correct
  ...
  memoryrx++;
  if (*memoryrx != 0xf443e3ca){
    fail(5);
    test_res = 5;
  }
  memoryrx++;
  if (*memoryrx != 0x4d62b59a){
    fail(7);
    test_res = 6;
  }
  memoryrx++;
  if (*memoryrx != 0xca84e990){
    fail(87);
    test_res = 7;
  }
  memoryrx++;
  if (*memoryrx != 0xcacaf5c5){
    fail(8);
    test_res = 8;
  }
  memoryrx++;
...
// Check that hash is correct
  memoryrx = (int*)memoryrxbase;
  if (*memoryrx != 0x5A733318){
    fail(1);
    test_res = 1;
  }
  memoryrx++;
  if (*memoryrx != 0xFC529E7B){
    fail(2);
    test_res = 2;
  }
  memoryrx++;
  if (*memoryrx != 0x4BC7F859){
    fail(3);
    test_res = 3;
  }
  memoryrx++;
  if (*memoryrx != 0x7966A336){
    fail(4);
    test_res = 4;
  }
  memoryrx++;
  if (*memoryrx != 0x5E9F8C63){
    fail(5);
    test_res = 5;
  }
  memoryrx++;
  if (*memoryrx != 0x21AF93A3){
    fail(6);
    test_res = 6;
  }
  memoryrx++;
  if (*memoryrx != 0x7A621D70){
    fail(7);
    test_res = 7;
  }
  memoryrx++;
  if (*memoryrx != 0x646564E6){
    fail(8);
    test_res = 8;
  }
  memoryrx++;
...
// Check that hash is correct
  memoryrx = (int*)memoryrxbase;
  if (*memoryrx != 0xA063DF83){
    fail(1);
    test_res = 1;
  }
  memoryrx++;
  if (*memoryrx != 0xA8C28A49){
    fail(2);
    test_res = 2;
  }
  memoryrx++;
  if (*memoryrx != 0xDAF4AEBA){
    fail(3);
    test_res = 3;
  }
  memoryrx++;
  if (*memoryrx != 0x0E29EE7B){
    fail(4);
    test_res = 4;
  }
  memoryrx++;
  if (*memoryrx != 0x2177E851){
    fail(5);
    test_res = 5;
  }
  memoryrx++;
  if (*memoryrx != 0x1072944C){
    fail(6);
    test_res = 6;
  }
  memoryrx++;
  if (*memoryrx != 0x3D299CF7){
    fail(7);
    test_res = 7;
  }
  memoryrx++;
  if (*memoryrx != 0x7DC83E7A){
    fail(8);
    test_res = 8;
  }
  memoryrx++;
...
// Check that hash is correct
  memoryrx = (int*)memoryrxbase;
  if (*memoryrx != 0xB9A9C636){
    fail(1);
    test_res = 1;
  }
  memoryrx++;
  if (*memoryrx != 0xA2553AD6){
    fail(2);
    test_res = 2;
  }
  memoryrx++;
  if (*memoryrx != 0xA826BE94){
    fail(3);
    test_res = 3;
  }
  if (*memoryrx != 0x755DC55A){
    fail(4);
    test_res = 4;
  }
  memoryrx++;
  if (*memoryrx != 0xA7013C9F){
    fail(5);
    test_res = 5;
  }
  memoryrx++;
  if (*memoryrx != 0xB23ABDC0){
    fail(6);
    test_res = 6;
  }
  memoryrx++;
  if (*memoryrx != 0xB61499CE){
    fail(7);
    test_res = 7;
  }
  memoryrx++;
  if (*memoryrx != 0x32DD6FD5){
    fail(8);
    test_res = 8;
  }
  memoryrx++;
...
// Check that stored data is same as transferred
  ...
  memoryrx++;
  if (*memoryrx != 0xF4F5F6F7){
    fail(2);
    test_res = 2;
  }
  memoryrx++;
  if (*memoryrx != 0xF8F9FAFB){
    fail(3);
    test_res = 3;
  }
  memoryrx++;
  if (*memoryrx != 0xFCFDFEFF){
    fail(4);
    test_res = 4;
  }
  memoryrx++;
...
// Check that stored data is same as transferred
  ...
  memoryrx++;
  if (*memoryrx != 0x603deb10){
    fail(5);
    test_res = 5;
  }
  memoryrx++;
  if (*memoryrx != 0x15ca71be){
    fail(6);
    test_res = 6;
  }
  memoryrx++;
  if (*memoryrx != 0x2b73aef0){
    fail(7);
    test_res = 7;
  }
  memoryrx++;
  if (*memoryrx != 0x857d7781){
    fail(8);
    test_res = 8;
  }
  memoryrx++;
