...
//Activate lockstep
activate_lockstep(50, 200);

enable_counters();
//END OF PRE-TEST FUNCTIONS
  binarysearch_init();
  binarysearch_main();
...
report_pmu();
//END OF POST-TEST FUNCTIONS
if (  ( binarysearch_return() - ( -1 ) != 0 ) == 0){ printf("------------- PASSED! ----------------"); } else { printf("----------------- FAIL ---------------"); printf("The result of the test was %d",   ( binarysearch_return() - ( -1 ) != 0 ));  }
