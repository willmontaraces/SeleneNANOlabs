...
void __attribute__ ((noinline)) insertsort_init()
{
...
int __attribute__ ((noinline)) insertsort_return()
{
  int i, returnValue = 0;
...
void __attribute__ ((noinline)) insertsort_main()
{
  int  i, j, temp;
  i = 2;
...
int main(void)
{
    ...
    switch (__CORE__) {
        ...
        case 2:
            ...
            *shared_result = insertsort_return();
            while(1);
            break;
