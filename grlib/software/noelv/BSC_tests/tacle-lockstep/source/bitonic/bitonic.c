...
void __attribute__ ((noinline)) bitonic_init( void )
{
...
void  __attribute__ ((noinline)) bitonic_main( void )
{
  int i;
...
{
    int i;
    volatile unsigned int *shared_flag_results = (unsigned int*) 0x52000000;
