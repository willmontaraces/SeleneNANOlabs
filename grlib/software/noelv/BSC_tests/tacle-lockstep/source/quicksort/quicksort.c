...
void __attribute__ ((noinline)) quicksort_init( void )
{
  unsigned int i, j;
  unsigned int x, y, z;
...
void  __attribute__ ((noinline)) quicksort_main( void )
{
...
int main(void)
{
    ...
    switch (__CORE__) {
        case 1: 
            ...
            if ( (quicksort_return() - 1527923179 != 0)  == 0 ) 
                printf(" PASSED\n");
            else
                printf(" FAILED\n");

            printf("Result_from_CORE2:");
            if ( (*shared_result - 1527923179 != 0)  == 0 )
                printf(" PASSED\n");
            else
                printf(" FAILED\n");
        ...
        case 2:
            ...
            *shared_result = quicksort_return();
            while(1);
            break;
