...
void __attribute__ ((noinline)) binarysearch_init( void )
{
  int i;
...
void  __attribute__ ((noinline)) binarysearch_main( void )
{
...
int main(void) {
    ...
    switch (__CORE__) {
        ...
        case 2:
            ...
            *shared_result = binarysearch_return();
            while(1);
            break;
