...
void __attribute__ ((noinline)) filterbank_init( void )
{
...
void __attribute__ ((noinline)) filterbank_main( void )
{
  float r[ 256 ];
  float y[ 256 ];
  float H[ 8 ][ 32 ];
...
int main(void)
{
    ...
    switch (__CORE__) {
        ...
        case 2:
            ...
            *shared_result = filterbank_return();
            while(1);
            break;
