...
void __attribute__ ((noinline)) countnegative_init( void )
{
...
/*
  The main function
*/
void __attribute__ ((noinline)) countnegative_main ( void )
{
...
int main(void)
{
    ...
    switch (__CORE__) {
        ...
        case 2:
            ...
            *shared_result = countnegative_return();
            while(1);
            break;
