...
void __attribute__ ((noinline)) complex_updates_init( void )
{
  int i;
  volatile float x = 0;
...
void __attribute__ ((noinline)) complex_updates_main( void )
{
...
int main(void)
{
    ...
    switch (__CORE__) {
        ...
        case 2:
            ...
            *shared_result = complex_updates_return();
            while(1);
            break;
