...
void __attribute__ ((noinline)) ludcmp_init( void )
{
  int             i, j, n = 5;
  double          w;
  volatile int    x = 0;
...
int __attribute__ ((noinline)) ludcmp_return( void )
{
  int i, n = 5;
...
void __attribute__ ((noinline)) ludcmp_main( void )
{
  int n = 5;
  double eps = 1;
