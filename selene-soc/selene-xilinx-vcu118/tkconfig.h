...
#ifndef CONFIG_IU_RV_M
#define CONFIG_IU_RV_M 0
#endif

#ifndef CONFIG_IU_RV_A
#define CONFIG_IU_RV_A 0
#endif

#ifndef CONFIG_IU_RV_FPU
#define CONFIG_IU_RV_FPU 0
#endif

#if defined CONFIG_IU_RV_F
#define CFG_IU_FPULEN 32
#elif defined CONFIG_IU_RV_D
#define CFG_IU_FPULEN 64
#elif defined CONFIG_IU_RV_Q
#define CFG_IU_FPULEN 128
#else
#define CFG_IU_FPULEN 0
#endif

#ifndef CONFIG_IU_RV_C
#define CONFIG_IU_RV_C 0
#endif

#ifndef CONFIG_IU_RV_S
#define CONFIG_IU_RV_S 0
#endif

#ifndef CONFIG_IU_RV_U
#define CONFIG_IU_RV_U 0
#endif

#ifndef CONFIG_IU_LATE_BRANCH
#define CONFIG_IU_LATE_BRANCH 0
#endif

#ifndef CONFIG_IU_LATE_ALU
#define CONFIG_IU_LATE_ALU 0
#endif

#ifndef CONFIG_BHT_ENABLE
#define CONFIG_BHT_ENABLE 0
#endif

#ifndef CONFIG_BHT_ENTRIES
#define CONFIG_BHT_ENTRIES 128
#endif

#ifndef CONFIG_BHT_BITS
#define CONFIG_BHT_BITS 5
#endif

#if defined CONFIG_BHT_BIMODAL
#define CFG_BHT_PREDICTOR 0
#elif defined CONFIG_BHT_PAG
#define CFG_BHT_PREDICTOR 1
#elif defined CONFIG_BHT_PAP
#define CFG_BHT_PREDICTOR 2
#else
#define CFG_BHT_PREDICTOR 1
#endif

#ifndef CONFIG_BTB_ENABLE
#define CONFIG_BTB_ENABLE 0
#endif

#ifndef CONFIG_BTB_ENTRIES
#define CONFIG_BTB_ENTRIES 32
#endif

#ifndef CONFIG_BTB_WAYS
#define CONFIG_BTB_WAYS 2
#endif
